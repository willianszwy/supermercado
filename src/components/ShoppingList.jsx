      ...
      <header className="py-3 flex justify-between items-center border-b-2 border-primary-blue mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {hasHistory && (
            <button
              onClick={onSmartList}
              className="w-10 h-10 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 flex items-center justify-center transition-colors border border-indigo-200"
