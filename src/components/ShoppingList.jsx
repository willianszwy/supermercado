...
function ShoppingList({ currentList, onAddProduct, onUpdateStatus, onUpdateProduct, onNewList, onSmartList, onClearList, onShowTour, onFinishCart, onShowHistory, hasHistory }) {
      ...
      <header className="py-3 flex justify-between items-center border-b-2 border-primary-blue mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {hasHistory && (
            <button
              onClick={onSmartList}
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 transition-colors font-medium text-sm border border-indigo-200"
              title="Gerar lista baseada no seu histórico"
            >
